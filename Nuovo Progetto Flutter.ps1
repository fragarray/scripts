...
Write-Host "Creazione nuovo progetto Flutter per VSCode"
...
# 6. Apertura con VSCode
if (Get-Command code -ErrorAction SilentlyContinue) {
    code .
} else {
    Write-Host "INFO: Il comando 'code' non è disponibile. Apri manualmente la cartella in VSCode."
}
